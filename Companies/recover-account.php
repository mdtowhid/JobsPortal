...
if(isset($_POST['submit'])){
    $status = $company->recoverAccount($_POST);
}

if(isset($_POST['recover_submit'])){
    $recStatus = $company->updatePassword($_POST);
    $status = 1;
}
?>
<!DOCTYPE html>
                ...
                <div class="row">
                    <form action="" method="post" class="center">
                            <div class="form-row custom-form-row">
                                <input type="text" name="CompanyId" value="<?php echo $_SESSION['CompanyId'] ?>" class="form-control" required hidden>
