...
//$jCategory = $admin->getJobCategoryById($id);
if (isset($_POST['submit'])) {
    $status = $admin->addJobCategory($_POST);
}
?>
    ...
    <div class="right">
        <div class="container">
            <div class="row">
                <div class="bodyTop col-md-12" >
                    <h3 class="text-center text-muted">Add New Job Category</h3>
                </div>
            </div>
                ...
                <form action="" method="POST" enctype="multipart/form-data" class="col-md-6">
                    <div class="">
                        <div class="mb-3">
                            ...
                            <input type="text" name="CatgoryName" value="" class="form-control" placeholder="Catgory Name"required>
                            <br>
